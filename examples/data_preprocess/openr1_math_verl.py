...
"""
Download and materialize the OpenR1-Math (verl format) dataset to local parquet files.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="~/data/openr1_math", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()

    data_source = "sungyub/openr1-math-verl"

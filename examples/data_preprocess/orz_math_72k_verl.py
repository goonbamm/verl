...
"""
Download and materialize the ORZ-Math-72k (verl format) dataset to local parquet files.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="~/data/orz_math_72k", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()

    data_source = "sungyub/orz-math-72k-verl"

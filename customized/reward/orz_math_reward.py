"""Custom reward function for ORZ-Math-72k datasets.

This reward intentionally reuses verl's built-in `math_reward` because ORZ
...
def compute_score(
    ...
    **kwargs,
    ...
    """Compute ORZ-Math reward using verl's built-in math reward.
